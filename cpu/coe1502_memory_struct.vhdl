...
ARCHITECTURE struct OF COE1502_memory IS
   ...
   -- LOAD PROGRAMS BELOW BY CHANGING THE VALUES STORED IN MW_U_0RAM_TABLE --
   SIGNAL mw_U_0ram_table : MW_U_0RAM_TYPE := (
		------------INSTRUCTION MEM BELOW---------------
		X"20070011",X"200BFFFD",X"00EB5824",X"ACEB0000",
		X"00000000",X"00000000",X"00000000",X"00000000",
		----------------DATA MEM BELOW------------------
		X"00000000",X"00000000",X"00000000",X"00000000",
		X"00000000",X"00000000",X"00000000",X"00000000"
	);
   SIGNAL mw_U_0addr_reg: std_logic_vector(3 DOWNTO 0) := "0000";
